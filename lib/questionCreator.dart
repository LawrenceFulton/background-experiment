...
class QuestionCreator {
  ...
  void setAutoverbotQuestions() {
    _setQuestions(
      ...
      [
        {'id': 'p1', 'text': 'Ist der Verkehr an und zu deiner Schule ein Problem?'},
        {'id': 'p2', 'text': 'Glaubst du, dass alle eine gute Alternative zur Verfügung hätten?'},
        {
          'id': 'p3',
  ...
  void setVeggieMensaQuestions() {
    _setQuestions(
      ...
      [
        {
          'id': 'p1',
          'text': 'Wie viele Schüler*innen und Lehrer*innen würden dann weniger gerne in der Schule essen?',
  ...
  void setSchulMitebestimmungsQuestions() {
    _setQuestions(
      ...
      [
        {'id': 'p1', 'text': 'Würde die Schüler*innenschaft das Geld sinnvoll einsetzen?'},
        {
          'id': 'p2',
        ...
        },
        {
          'id': 'p3',
          'text':
              'Glaubst du, dass die Schüler*innen fähig sind, selbstbestimmt und demokratisch über die Verwendung zu entscheiden?'
        },
  ...
  void setNachhaltigkeitsQuestions() {
    _setQuestions(
      ...
      [
        {'id': 'p1', 'text': 'Spielt Nachhaltigkeit eine große Rolle an deiner Schule?'},
        {'id': 'p2', 'text': 'Sollte deine Schule Nachhaltig aktiv als wichtigen Grundwert vermitteln?'},
        {
          'id': 'p3',
          'text':
              'Ist es eher individuelle, persönliche Verantwortung oder gesellschaftliche Verantwortung, mehr gegen den Klimawandel zu tun?',
